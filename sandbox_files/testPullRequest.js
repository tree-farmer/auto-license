...
function main() {
  createLicenseFile(repoOwner, 'auto-license', 'test', licensePath, pullReqMessage, mitLicenseBase64);
  setTimeout(null, 3000);
  createPullRequest(repoOwner, 'auto-license', pullRequestTitle, 'test', 'master');
}
